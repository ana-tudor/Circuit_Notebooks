...
molecule = MolecularData(filename='data/H4-C2_DZP_singlet_ethylene_1.57080.hdf5')
...
#Read in data, parse for correct values
input_amplitudes = np.loadtxt('C:\Users\hp\Documents\GitHub\CircuitNotebooks\Scripts\input.txt', \
        dtype=np.dtype('d'))
...
name = "C:\Users\hp\Documents\GitHub\CircuitNotebooks\Scripts\output.txt"
